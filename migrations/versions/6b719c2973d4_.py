...
Revision ID: 6b719c2973d4
Revises: 7ec6c2a6a1c8
Create Date: 2023-10-12 17:54:08.208845
...
def upgrade():
    ...
    sa.Column('last_updated', sa.DateTime(), server_default='2023-10-12', nullable=True),
